          ...
          <div id='wordData'>
            ...
            <script>
                ...
                function makeModal() {
                    ...
                    if(totalArray.length>tableData.length){
                        for(var i=0; i<tableData.length; i++){

                        }
                    }
                    else if(totalArray.length<tableData.length){
                        for(var i=0; i<tableData.length; i++){
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id ="saveData" style="float: right"></div>
                <div id ="currentData" style="float: left"></div>
            </div>
